                ...
                <div className={style.content}>
                    ...
                    <div className={style.right}>
                        ...
                        <div className={style.links}>
                            {instagram && (
                                <a target={"_blank"} href={instagram} className={style.link}>
                            ...
                            {tiktok && (
                                <a target={"_blank"} href={tiktok} className={style.link}>
                                    <svg width="40" height="40" viewBox="0 0 40 40">
                                        <path
                            ...
                            {twitter && (
                                <a target={"_blank"} href={twitter} className={style.link}>
                                    <svg width="40" height="40" viewBox="0 0 40 40">
                                        <path
                            ...
                            {facebook && (
                                <a target={"_blank"} href={facebook} className={style.link}>
                                    <svg width="40" height="40" viewBox="0 0 40 40">
                                        <path
                            ...
                            {youtube && (
                                <a target={"_blank"} href={youtube} className={style.link}>
                                    <svg width="40" height="40" viewBox="0 0 40 40">
                                        <path
                            ...
                            {telegram && (
                                <a target={"_blank"} href={telegram} className={style.link}>
                                    <svg width="40" height="40" viewBox="0 0 40 40">
                                        <path
