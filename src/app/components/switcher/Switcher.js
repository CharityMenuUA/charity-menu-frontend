...
const SwitcherProviderSearch = (props) => {
...
const SwitcherProviderFallback = (props) => {
    const {children} = props

    return (
        <SwitcherContext.Provider value={{value: false}}>
            {children}
        </SwitcherContext.Provider>
    )
}
...
const SwitcherProvider = (props) => {
    return (
        <Suspense fallback={<SwitcherProviderFallback {...props}/>}>
            <SwitcherProviderSearch {...props}/>
        </Suspense>
    )
}
