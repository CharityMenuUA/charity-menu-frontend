                ...
                <div className={style.sponsor}>
                    ...
                    <div className={style.sponsor_info}>
                        ...
                        <div className={style.socials}>
                            {sponsor?.instagram && (
                                <a href={sponsor?.instagram} className={style.socials_icon} target="_blank">
                            ...
                            {sponsor?.twitter && (
                                <a href={sponsor?.twitter} className={style.socials_icon} target="_blank">
                                    <svg width="40" height="40" viewBox="0 0 40 40">
                                        <path
                            ...
                            {sponsor?.facebook && (
                                <a href={sponsor?.facebook} className={style.socials_icon} target="_blank">
                                    <svg width="40" height="40" viewBox="0 0 40 40">
                                        <path
                            ...
                            {sponsor?.telegram && (
                                <a href={sponsor?.telegram} className={style.socials_icon} target="_blank">
                                    <svg width="40" height="40" viewBox="0 0 40 40">
                                        <path
                            ...
                            {sponsor?.linkedin && (
                                <a href={sponsor?.linkedin} className={style.socials_icon} target="_blank">
                                    <svg width="40" height="40" viewBox="0 0 40 40">
                                        <path
